...
<body>
        ...
        <div class="order">
            <div class="orderinfo">
                ...
                <div id="deliverycheck">
                        <label class="radiobt"><input type="radio" name="delivery"  checked="checked" value="기존 배송지"/><span><br>기존 배송지</span></label>
                        <label class="radiobt"><input type="radio" name="delivery" value="새로운 배송지"/><span><br>새로운 배송지</span></label>
                </div>
                ...
                <div id="order_content">
                    <table class="table_content">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="postcode" id="postcode" name="postcode" readonly/>
                        ...
                        <tr>
                            <th></th>
                            <td><input type="text" class="address" id="address" name="address" readonly/></td>
                        </tr>
                        <tr>
                            <th></th>
                            <td><input type="text" class="address_detail" name="address_detail" /></td>
                        </tr>
                        <tr>
    ...
    <div class="container2">    
        ...
        <div class="mileage">
            ...
            <table class="mileage_content">
                <tr>
                    <th>마일리지</th>
                    <td><input type="text" class="mileage_table" name="mileage_table" autocapitalize="none" inputmode="numeric" value="0"></td>
                    <td><input type="button" class="mileagebt" name="meileagebt" value="모두 사용"></td>
                    <td><span class="span_mg">보유 마일리지</span></td>
                </tr>
            </table>
    ...
    <section>
        <div class="section">
            ...
            <div class="product_content">
                ...
                <span class="product_mileage2">- <span></span>P</span>
            </div>
            <div class="product_content">
            ...
            <div class="product_content">
                ...
                <span class="product_total2"><span class="product_total3">180,000</span> 원</span>
            </div>
    
            <div class="notice">
                <span>결제 안내 시 상호명은 (주)3조로 표기되니 참고 부탁드립니다.</span>
            </div>
            ...
            <div class="wrap">
                <a href="#pop_info_1" class="notice3">개인정보 제 3자 제공동의 보기</a><br>
    ...
    <section>
        <div class="submit">
         <input type="button" id="submitbt" name="submitbt" value="CHECK OUT">
